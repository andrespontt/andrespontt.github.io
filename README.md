...
- **Apartment** (`apartment.html`) - Atmospheric first-person horror sandbox: a furnished apartment, rainy street, an unwelcome clown, protective bodyguards, and callable security backup
